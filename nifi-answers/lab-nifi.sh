...
cp -rp ./flow.xml.lab.gz /etc/nifi/nifi-0/conf/flow.xml.gz
cp -rp ./flow.xml.lab.gz /etc/nifi/nifi-1/conf/flow.xml.gz
cp -rp ./flow.xml.lab.gz /etc/nifi/nifi-2/conf/flow.xml.gz
